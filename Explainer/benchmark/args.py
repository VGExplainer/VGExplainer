    ...
    def process_args(self) -> None:
        ...
        if self.ckpt_dir == None:
            '''self.ckpt_dir = os.path.join(ROOT_DIR, 'checkpoints',
                                         ...
                                         str(self.target_idx))'''
            self.ckpt_dir = 'nvd-8-75.01018053481742-69.44905409890475-DevignModel_2d.ckpt'
...
class TestArgs(GeneralArgs):
    ...
    def process_args(self) -> None:
        ...
        if self.test_ckpt == None:
            ...
            # self.test_ckpt = '/home/bigvul/train_data/models/devign/devign52.79_53.54_75.31_62.59.ckpt'
            # self.test_ckpt = '/home/bigvul/train_data/models/ivdetect/ivdetect52.35_53.64_74.69_62.44.ckpt'
            # self.test_ckpt = '/home/bigvul/train_data/models/reveal/reveal52.99_54.4_70.0_61.22.ckpt'
            # self.test_ckpt = '/home/bigvul/train_data/models/deepwukong/deepwukong52.48_53.91_71.34_61.41.ckpt'


            # self.test_ckpt = '/home/primevul/model/devign/f1_0.5866_acc_0.5644_pre_0.5586_rec_0.6176_best.pt'
            # self.test_ckpt = '/home/primevul/model/ivdetect/f1_0.6224_acc_0.5996_pre_0.5894_rec_0.6593_best.pt'
            # self.test_ckpt = '/home/primevul/model/deepwukong/f1_0.5771_acc_0.5567_pre_0.5522_rec_0.6044_best.pt'
            self.test_ckpt = '/home/primevul/model/reveal/f1_0.5883_acc_0.5336_pre_0.5270_rec_0.6659.pt'
