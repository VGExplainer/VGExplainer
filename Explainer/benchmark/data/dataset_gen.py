...
ROOT_DIR = '/home/VGExplainer/Explainer'
import os
...
class Devign(InMemoryDataset):
    ...
    def process(self):
        ...
        with open('/home/VGExplainer/train_model/primevul/model/class_1.txt','r') as f:###
            dataset_list = f.readlines()
        #random.shuffle(dataset_list)
        i = 0
        for data_name in dataset_list:
            data_name = data_name.strip()
            data_name = '/home/Dataset/primevul/4_embedding/pdg_norm/'+data_name  ###
