...
if __name__ == '__main__':
    ...
    for file in all_files:
        ...
        # m1={'role': 'user', 'content': f'''# Role: You are a professional vulnerability analyst. You are good at analyzing vulnerabilities in code line by line and overall, and can provide specific vulnerability line numbers.
        # # Task: Your task is to carefully analyze the vulnerabilities in the code and provide specific line numbers for the vulnerabilities.
        # # Requirement: 
        ...
        # 2. You should read and analyze the vulnerabilities in the code line by line. And review potential vulnerabilities again in conjunction with the overall code to ensure that no vulnerability is missed and that the vulnerabilities found are indeed present.
        # 3. Tell user vulnerability line numbers as the answer in a list format as follows: [...,...,...]. No other information needs to be output.
        # 4. Your answer must be rigorous and accurate, and fabrication is prohibited.
        # # The given code: 
        # {test_code}
        # '''}
        ...
        response_1: ChatResponse = chat(model='llama3.1:8b', messages=[m1])
        ...
        2. You need to output the extracted vulnerability line numbers in the following format: ```json [num1,num2,...] ```. Ensure that your results are output strictly in accordance with the formatting requirements. For example, do not use the \ box format to output.
