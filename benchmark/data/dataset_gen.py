...
class Devign(InMemoryDataset):
    ...
    def process(self):
        ...
        with open('/home/VulGnnExp/train_data/dataset/devign_1.txt','r') as f:##
            dataset_list = f.readlines()
        #random.shuffle(dataset_list)
        i = 0
        for data_name in dataset_list:
            data_name = data_name.strip()
            data_name = '/home/my_CodeTransformationTest2/myvulexp/com_json/15/'+data_name
